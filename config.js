System.config({
  ...
  bundles: {
    ...
    "app-build.js": [
      "data/code_examples/dummy_01.txt!github:systemjs/plugin-text@0.0.8.js",
      "data/code_examples/fileA.txt!github:systemjs/plugin-text@0.0.8.js",
      "data/code_examples/fileB.txt!github:systemjs/plugin-text@0.0.8.js",
      "data/code_examples/tutorial01.txt!github:systemjs/plugin-text@0.0.8.js",
      "data/experiment_questions/dummy_01.json!github:systemjs/plugin-json@0.3.0.js",
      "data/experiment_questions/fileA.json!github:systemjs/plugin-json@0.3.0.js",
      "data/experiment_questions/fileB.json!github:systemjs/plugin-json@0.3.0.js",
      "data/survey_questions/post_survey.json!github:systemjs/plugin-json@0.3.0.js",
      "data/survey_questions/pre_survey.json!github:systemjs/plugin-json@0.3.0.js",
      "editor/editor.html!github:systemjs/plugin-text@0.0.8.js",
      "editor/editor.js",
      "main.js",
      "scoped_a/ace-viewport.js",
      "scoped_a/color-manager.js",
      "scoped_a/packed-circle-tree.js",
      "scoped_a/scoped.html!github:systemjs/plugin-text@0.0.8.js",
      "scoped_a/scoped.js",
      "scoped_a/source-code-parser.js",
      "scoped_a/variable-list-item1.js",
      "scoped_a/vis-overview-viewport.html!github:systemjs/plugin-text@0.0.8.js",
      "scoped_a/vis-overview-viewport.js",
      "scoped_a/vis-variables-viewport.html!github:systemjs/plugin-text@0.0.8.js",
      "scoped_a/vis-variables-viewport.js",
      "scoped_a/vis-viewport.html!github:systemjs/plugin-text@0.0.8.js",
      "scoped_a/vis-viewport.js",
      "scoped_c/ace-viewport.js",
      "scoped_c/color-manager.js",
      "scoped_c/packed-circle-tree.js",
      "scoped_c/scoped.html!github:systemjs/plugin-text@0.0.8.js",
      "scoped_c/scoped.js",
      "scoped_c/source-code-parser.js",
      "scoped_c/vis-overview-viewport.html!github:systemjs/plugin-text@0.0.8.js",
      "scoped_c/vis-overview-viewport.js",
      "scoped_c/vis-viewport.html!github:systemjs/plugin-text@0.0.8.js",
      "scoped_c/vis-viewport.js",
      "scoped_d/ace-viewport.js",
      "scoped_d/color-manager.js",
      "scoped_d/packed-circle-tree.js",
      "scoped_d/scoped.html!github:systemjs/plugin-text@0.0.8.js",
      "scoped_d/scoped.js",
      "scoped_d/source-code-parser.js",
      "scoped_d/variable-list-item1.js",
      "scoped_d/vis-overview-viewport.html!github:systemjs/plugin-text@0.0.8.js",
      "scoped_d/vis-overview-viewport.js",
      "scoped_d/vis-variables-viewport.html!github:systemjs/plugin-text@0.0.8.js",
      "scoped_d/vis-variables-viewport.js",
      ...
      "views/app.js",
      "views/def1_ab.html!github:systemjs/plugin-text@0.0.8.js",
      "views/def1_ab.js",
      "views/end.html!github:systemjs/plugin-text@0.0.8.js",
      "views/end.js",
      "views/ga/step_1.html!github:systemjs/plugin-text@0.0.8.js",
      "views/ga/step_1.js",
      "views/gb/step_1.html!github:systemjs/plugin-text@0.0.8.js",
      "views/gb/step_1.js",
      "views/gc/step_1.html!github:systemjs/plugin-text@0.0.8.js",
      "views/gc/step_1.js",
      "views/gd/step_1.html!github:systemjs/plugin-text@0.0.8.js",
      "views/gd/step_1.js",
      "views/mobile.html!github:systemjs/plugin-text@0.0.8.js",
      "views/mobile.js",
      "views/survey1.html!github:systemjs/plugin-text@0.0.8.js",
      "views/survey1.js",
      "views/survey2.html!github:systemjs/plugin-text@0.0.8.js",
      "views/survey2.js",
  ...
  depCache: {
    ...
    "views/ga/step_1.js": [
      ...
      "aurelia-event-aggregator",
      "../../services/data_manager.js",
      "../../data/code_examples/dummy_01.txt!text",
      "../../data/experiment_questions/dummy_01.json!json",
      "../../data/code_examples/fileA.txt!text",
      "../../data/code_examples/fileB.txt!text",
      "../../data/experiment_questions/fileA.json!json",
      "../../data/experiment_questions/fileB.json!json",
      "jquery",
      "introJs",
      "introJs/minified/introjs.min.css!css",
      "../../../styles/introjs-custom.css!css"
    ],
    "views/gb/step_1.js": [
      "aurelia-framework",
      "aurelia-router",
    ...
    "views/survey1.js": [
      ...
      "jquery",
      "survey-jquery",
      "../data/survey_questions/pre_survey.json!json"
    ],
    "views/survey2.js": [
      "aurelia-framework",
      "aurelia-router",
      ...
      "jquery",
      "survey-jquery",
      "../data/survey_questions/post_survey.json!json"
    ],
    "views/welcome.js": [
      "aurelia-framework",
      "aurelia-router",
